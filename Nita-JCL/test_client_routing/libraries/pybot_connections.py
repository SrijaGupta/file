...
class pybot_connections(object):
    ...
    def __repr__ (self):
            ...
            return "pybot_connection: username=%s, target=%s, port=%s, password=%s, prompt=%s, device_type=%s" %(self.username, self.target, self.port, self.password, self.prompt, self.device_type)
