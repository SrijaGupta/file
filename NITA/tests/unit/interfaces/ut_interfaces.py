...
class UnitTest(unittest.TestCase):
    ...
    def test_get_interface_hardware_address_exception(self):
        try:
           interfaces.get_interface_hardware_address() 
        ...
        try:
           interfaces.get_interface_hardware_address(device=self.mocked_obj) 
        except Exception as err:
            self.assertEqual(
                err.args[0],
    ...
    def test_get_interface_hardware_address_execution_1(self):
        ...
        self.assertEqual(interfaces.get_interface_hardware_address(device=self.mocked_obj, interface="xe-2/2/0"), 
                         "44:f4:77:92:58:b4")
    ...
    def test_get_interface_hardware_address_execution_2(self):
        ...
        self.mocked_obj.cli = MagicMock(side_effect=lst)
        try:
            interfaces.get_interface_hardware_address(device=self.mocked_obj, interface="xe-2/2/0")
        except Exception as err:
            self.assertEqual(
                err.args[0],
