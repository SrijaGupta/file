...
try:
        ...
        nt=AclEntryInet6NonTerminatingAction(action_count = AclActionCounter(counter_name="Match1"),action_syslog=1,action_log=1,action_sample=1)
        ...
        filter=AccessList(acl_name = "INET61",acl_type = ACL_TYPE_INVALID, acl_family = ACL_FAMILY_INET6, acl_flag = ACL_FLAGS_NONE, ace_list=[tlist1])
        print filter
        ...
        pause()
        filter = AccessList(acl_name="INET61",acl_family = ACL_FAMILY_INET6)
        print filter
