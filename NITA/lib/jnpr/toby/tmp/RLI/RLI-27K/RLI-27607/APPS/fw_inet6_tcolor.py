...
try:
        ...
        flag = 0
        res=[]
        pparam=AclPolicerParameter(two_color_parameter=AclPolicerTwoColor(bw_unit=ACL_POLICER_RATE_MBPS,bandwidth=100000,burst_unit=ACL_POLICER_BURST_SIZE_GBYTE,burst_size=100,lp=ACL_LOSS_PRIORITY_MEDIUM_LOW, discard = True))
        pol1=AccessListPolicer(policer_name="P1",policer_type=ACL_TWO_COLOR_POLICER,policer_flag=ACL_POLICER_FLAG_TERM_SPECIFIC,policer_params=pparam)
