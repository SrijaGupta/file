...
try:
        ...
        flag = 0
        res=[]
        pparam=AclPolicerParameter(hierarchical_parameter=AclPolicerHierarchical(aggregate_rate_unit=ACL_POLICER_RATE_BPS,aggregate_rate=9000,aggregate_burst_size_unit=ACL_POLICER_BURST_SIZE_KBYTE,aggregate_burst_size=2500,premium_rate_unit=ACL_POLICER_RATE_BPS,premium_rate=8999,premium_burst_size_unit=ACL_POLICER_BURST_SIZE_KBYTE,premium_burst_size=2000,discard=ACL_TRUE))
        ...
        nt=AclEntryVplsNonTerminatingAction(action_count = AclActionCounter(counter_name="Match1"),action_log=1,action_sample=1,action_syslog=1,action_policer=AclActionPolicer(policer=pol1))
