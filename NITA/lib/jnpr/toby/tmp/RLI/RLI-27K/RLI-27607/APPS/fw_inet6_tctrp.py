...
try:
        ...
        flag = 0
        res=[]
        pparam=AclPolicerParameter(tr_three_color_parameter=AclPolicerTwoRateThreeColor(committed_rate_unit=ACL_POLICER_RATE_KBPS,committed_rate=10,committed_burst_unit=ACL_POLICER_BURST_SIZE_KBYTE,committed_burst_size=1500,excess_rate_unit=ACL_POLICER_RATE_KBPS,excess_rate=20,excess_burst_size=2000,excess_burst_unit=ACL_POLICER_BURST_SIZE_KBYTE,discard=ACL_TRUE,color_mode=ACL_COLOR_MODE_COLOR_BLIND))
        pol1=AccessListPolicer(policer_name="P1",policer_type=ACL_TWO_RATE_THREE_COLOR_POLICER,policer_flag=ACL_POLICER_FLAG_TERM_SPECIFIC,policer_params=pparam)
        ...
        t1 = AclEntryInet6TerminatingAction(action_accept=1)
        nt=AclEntryInet6NonTerminatingAction(action_count = AclActionCounter(counter_name="Match1"),action_log=1,action_syslog=1,action_policer=AclActionPolicer(policer=pol1))
        nt1 = AclEntryInet6NonTerminatingAction(action_count=AclActionCounter(counter_name="Match2"))
        term1Action1 = AclEntryInet6Action(action_t=t, actions_nt=nt)
        term1Action2 = AclEntryInet6Action(action_t=t1, actions_nt=nt1)
        ...
        term2 = AclInet6Entry(ace_name="t2", ace_op=ACL_ENTRY_OPERATION_ADD, adjacency=adj,actions=term1Action2)
        tlist2 = AclEntry(inet6_entry=term2)

        filter = AccessList(acl_name="f1", acl_type=ACL_TYPE_CLASSIC, acl_family=ACL_FAMILY_INET6,acl_flag=ACL_FLAGS_NONE, ace_list=[tlist1,tlist2])
        print filter
