...
try:
    ...
    #rt = AclActionRoutingInstance(rt_instance_name=" ")
    rt = AclActionRoutingInstance(rt_instance_name='aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
    t = AclEntryInet6TerminatingAction(action_rt_inst=rt)
