...
try:
    ...
    ifl1 = AclActionIflNameIndex(ifl_name = args.iflname + '.0')
    intf = AclActionNextInterface(rti_name = 'r1', ifl = ifl1)
    nt = AclEntryInet6NonTerminatingAction(action_next_intf = intf)
