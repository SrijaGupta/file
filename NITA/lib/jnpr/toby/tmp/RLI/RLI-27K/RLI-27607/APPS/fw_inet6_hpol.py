...
try:
        ...
        flag = 0
        res=[]
        pparam=AclPolicerParameter(hierarchical_parameter=AclPolicerHierarchical(aggregate_rate_unit=ACL_POLICER_RATE_BPS,aggregate_rate=9000,aggregate_burst_size_unit=ACL_POLICER_BURST_SIZE_KBYTE,aggregate_burst_size=1500,premium_rate_unit=ACL_POLICER_RATE_BPS,premium_rate=8999,premium_burst_size_unit=ACL_POLICER_BURST_SIZE_KBYTE,premium_burst_size=2000,discard=ACL_TRUE))
        pol1=AccessListPolicer(policer_name="P1",policer_type=ACL_HIERARCHICAL_POLICER,policer_flag=ACL_POLICER_FLAG_FILTER_SPECIFIC,policer_params=pparam)
        ...
        nt=AclEntryInet6NonTerminatingAction(action_count = AclActionCounter(counter_name="Match1"),action_log=1,action_syslog=1,action_sample=1,action_policer=AclActionPolicer(policer=pol1))
