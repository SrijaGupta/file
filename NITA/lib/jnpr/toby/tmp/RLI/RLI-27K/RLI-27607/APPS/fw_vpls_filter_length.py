...
try:
        ...
        for filtname in fname:
                ...
                nt=AclEntryVplsNonTerminatingAction(action_count = AclActionCounter(counter_name="C1"),action_syslog=1,action_log=1,action_sample=1)
                ...
                filter=AccessList(acl_name = filtname,acl_type = ACL_TYPE_CLASSIC, acl_family = ACL_FAMILY_VPLS, acl_flag = ACL_FLAGS_NONE, ace_list=[tlist1])
                print filter
                ...
                pause()
                filter = AccessList(acl_name=filtname,acl_family = ACL_FAMILY_VPLS)
                print filter
