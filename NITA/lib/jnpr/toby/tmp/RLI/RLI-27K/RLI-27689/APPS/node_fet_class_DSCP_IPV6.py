...
try:
	...
	api_request = CosNodeBindFeatures(node_type=CosNodeType_LOGICAL_INTERFACE ,
					 ...
					 node_family_features=[CosNodeFamilyFeature(feature_option=CosNodeFeatureOption( classifier_family = classifier_family_DSCP_IPV6 ),
	...
	api_request = CosNodeBindFeatures(node_type=CosNodeType_LOGICAL_INTERFACE ,
					 ...
					 node_family_features=[CosNodeFamilyFeature(feature_option=CosNodeFeatureOption( classifier_family = classifier_family_DSCP_IPV6_MPLS ),
										    operation = operation_ADD,
										    direction=direction_INGRESS,
										    feature_object_name = "cos1",
					 					    feature_type=feature_type_classifier_rule)],)
