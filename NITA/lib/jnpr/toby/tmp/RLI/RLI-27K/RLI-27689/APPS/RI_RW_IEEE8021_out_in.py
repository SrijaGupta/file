...
try:
	...
	api_request = CosRoutingInstanceBindPoint(
						 rewrites=[CosRoutingInstanceRewrite(feature_object_name="cos1",
						 type=rw_type_IEEE8021,
						 feature_ieee8021_tag_mode = rw_tag_OUTER_AND_INNER,
						 operation=ATTRIB_ADD)], 
	...
	pause()
	print "################################################################################################ RT Change Change ###############"
	print "################################################################################################################################"


	api_request = CosRoutingInstanceBindPoint(
						 rewrites=[CosRoutingInstanceRewrite(feature_object_name="cos",
						 type=rw_type_IEEE8021,
						 feature_ieee8021_tag_mode = rw_tag_OUTER_AND_INNER,
						 operation=ATTRIB_ADD)], 
						 routing_instance_name="pe1")
