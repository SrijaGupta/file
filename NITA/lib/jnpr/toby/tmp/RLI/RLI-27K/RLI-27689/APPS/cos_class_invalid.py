...
try:
	...
	classifier_rewrite_type_INVALID 	=  FEATURE_CP_TYPE_INVALID
	...
	print "################################################################################################################################"
 	...
 	api_request = CosClassifier(classifier_name	="cos1", 
				    classifier_type	=classifier_rewrite_type_INVALID,
				    sharable		=True, ######### FALSE
	...
	api_request = CosClassifier(classifier_name="cos", classifier_type=classifier_rewrite_type_INVALID)
	...
	print "################################################################################################################################"
    	...
    	api_request = CosClassifier(classifier_name="cos1", classifier_type=classifier_rewrite_type_INVALID,)# rule=[ClassifierRule(code_points=[1], forwarding_class_name="be1")])
