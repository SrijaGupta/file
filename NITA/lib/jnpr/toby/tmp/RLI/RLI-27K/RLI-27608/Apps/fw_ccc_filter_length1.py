...
try:
        ...
        for filtname in fname:
                ...
                filter=AccessList(acl_name = filtname,acl_type = ACL_TYPE_CLASSIC, acl_family = ACL_FAMILY_CCC, acl_flag = ACL_FLAGS_NONE, ace_list=[tlist1])
                print filter
                ...
                pause()
                filter = AccessList(acl_name=filtname,acl_family = ACL_FAMILY_CCC)
                print filter
