...
try:
        ...
        term1=AclCccEntry(ace_name="t1",ace_op=ACL_ENTRY_OPERATION_INVALID,adjacency=adj,matches=term1match1,actions=term1Action1)
        ...
        term1match1 = AclEntryMatchCcc(match_dst_macs=[matchMAC1], match_src_macs=[matchMAC2])
        t = AclEntryCccTerminatingAction(action_accept=1)
        nt=AclEntryCccNonTerminatingAction(action_count = AclActionCounter(counter_name="Match1"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)
        ...
        adj=AclAdjacency(type=ACL_ADJACENCY_AFTER)
        term2=AclCccEntry(ace_name="t2",ace_op=ACL_ENTRY_OPERATION_REPLACE,adjacency=adj,matches=term1match1,actions=term1Action1)
        ...
        for i in range(1,3):
            term1=AclCccEntry(ace_name="t"+str(i),ace_op=ACL_ENTRY_OPERATION_DELETE,adjacency=adj,matches=term1match1,actions=term1Action1)
            tlist1=AclEntry(ccc_entry=term1)
