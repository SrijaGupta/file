...
try:
        ...
        term1 = AclMultiServiceEntry(ace_name="t1", ace_op=ACL_ENTRY_OPERATION_INVALID, adjacency=adj, matches=term1match1,actions=term1Action1)
        ...
        adj = AclAdjacency(type=ACL_ADJACENCY_AFTER)
        term1 = AclMultiServiceEntry(ace_name="t1", ace_op=ACL_ENTRY_OPERATION_REPLACE, adjacency=adj, matches=term1match1,actions=term1Action1)
        tlist1 = AclEntry(mservice_entry=term1)
        ...
        for i in range(1,3):
            term1=AclMultiServiceEntry(ace_name="t"+str(i),ace_op=ACL_ENTRY_OPERATION_DELETE,adjacency=adj,matches=term1match1,actions=term1Action1)
            tlist1=AclEntry(mservice_entry=term1)
