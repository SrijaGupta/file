...
try:
        ...
        for filtname in fname:
                ...
                nt=AclEntryMplsNonTerminatingAction(action_count = AclActionCounter(counter_name="C1"))
                ...
                filter=AccessList(acl_name = filtname,acl_type = ACL_TYPE_CLASSIC, acl_family = ACL_FAMILY_MPLS, acl_flag = ACL_FLAGS_NONE, ace_list=[tlist1])
                print filter
                ...
                pause()
                filter = AccessList(acl_name=filtname,acl_family = ACL_FAMILY_MPLS)
                print filter
