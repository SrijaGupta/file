...
try:
        ...
        # matchMPLS2 = AclMatchMplsLabel(min=200, max=1048575, match_op=ACL_MATCH_OP_NOT_EQUAL)
        ...
        filter=AccessList(acl_name = "MPLS1",acl_type = ACL_TYPE_INVALID, acl_family = ACL_FAMILY_MPLS, acl_flag = ACL_FLAGS_NONE, ace_list=[tlist1])
        print filter
