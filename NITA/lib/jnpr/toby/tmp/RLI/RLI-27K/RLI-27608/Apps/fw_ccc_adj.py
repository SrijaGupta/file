...
try:
        ...
        term1match1=AclEntryMatchCcc(match_dst_macs=[matchIP2],match_src_macs=[matchIP1])
        t=AclEntryCccTerminatingAction(action_accept = ACL_TRUE)
        nt=AclEntryCccNonTerminatingAction(action_count = AclActionCounter(counter_name="C1"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)

        adj=AclAdjacency(type=ACL_ADJACENCY_NONE,ace_name='')
        term1=AclCccEntry(ace_name="t1",ace_op=ACL_ENTRY_OPERATION_ADD,adjacency=adj,matches=term1match1,actions=term1Action1)
        ...
        term1match1 = AclEntryMatchCcc(match_dst_macs=[matchIP2], match_src_macs=[matchIP1])
        t = AclEntryCccTerminatingAction(action_accept=ACL_TRUE)
        nt = AclEntryCccNonTerminatingAction(action_count=AclActionCounter(counter_name="C2"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)

        adj = AclAdjacency(type=ACL_ADJACENCY_AFTER, ace_name='t3')
        term1 = AclCccEntry(ace_name="t2", ace_op=ACL_ENTRY_OPERATION_ADD, adjacency=adj, matches=term1match1,actions=term1Action1)
        tlist1 = AclEntry(ccc_entry=term1)
        ...
        term1match1 = AclEntryMatchCcc(match_dst_macs=[matchIP2], match_src_macs=[matchIP1])
        t = AclEntryCccTerminatingAction(action_accept=ACL_TRUE)
        nt = AclEntryCccNonTerminatingAction(action_count=AclActionCounter(counter_name="C3"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)

        adj = AclAdjacency(type=ACL_ADJACENCY_BEFORE, ace_name='t5')
        term1 = AclCccEntry(ace_name="t3", ace_op=ACL_ENTRY_OPERATION_ADD, adjacency=adj, matches=term1match1,actions=term1Action1)
        tlist1 = AclEntry(ccc_entry=term1)
        ...
        term1match1 = AclEntryMatchCcc(match_dst_macs=[matchIP2], match_src_macs=[matchIP1])
        t = AclEntryCccTerminatingAction(action_accept=ACL_TRUE)
        nt = AclEntryCccNonTerminatingAction(action_count=AclActionCounter(counter_name="C4"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)
        ...
        term1match1 = AclEntryMatchCcc(match_dst_macs=[matchIP2], match_src_macs=[matchIP1])
        t = AclEntryCccTerminatingAction(action_accept=ACL_TRUE)
        nt = AclEntryCccNonTerminatingAction(action_count=AclActionCounter(counter_name="C5"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)

        adj=AclAdjacency(type=ACL_ADJACENCY_AFTER,ace_name='t1')
        term2=AclCccEntry(ace_name="t2",ace_op=ACL_ENTRY_OPERATION_ADD,adjacency=adj,matches=term1match1,actions=term1Action1)
        tlist2=AclEntry(ccc_entry=term2)

        filter=AccessList(acl_name = "CCC1",acl_type = ACL_TYPE_CLASSIC, acl_family = ACL_FAMILY_CCC, acl_flag = ACL_FLAGS_NONE, ace_list=[tlist2])
        print filter
        ...
        term1match1 = AclEntryMatchCcc(match_dst_macs=[matchIP2], match_src_macs=[matchIP1])
        t = AclEntryCccTerminatingAction(action_accept=ACL_TRUE)
        nt = AclEntryCccNonTerminatingAction(action_count=AclActionCounter(counter_name="C6"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)
        ...
        term1match1 = AclEntryMatchCcc(match_dst_macs=[matchIP2], match_src_macs=[matchIP1])
        t = AclEntryCccTerminatingAction(action_accept=ACL_TRUE)
        nt = AclEntryCccNonTerminatingAction(action_count=AclActionCounter(counter_name="C7"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)

        adj=AclAdjacency(type=ACL_ADJACENCY_BEFORE,ace_name='t1')
        term2=AclCccEntry(ace_name="t4",ace_op=ACL_ENTRY_OPERATION_ADD,adjacency=adj,matches=term1match1,actions=term1Action1)
        tlist2=AclEntry(ccc_entry=term2)
        ...
        term1match1 = AclEntryMatchCcc(match_dst_macs=[matchIP2], match_src_macs=[matchIP1])
        t = AclEntryCccTerminatingAction(action_accept=ACL_TRUE)
        nt = AclEntryCccNonTerminatingAction(action_count=AclActionCounter(counter_name="C8"))
        term1Action1 = AclEntryCccAction(action_t=t, actions_nt=nt)

        adj=AclAdjacency(type=ACL_ADJACENCY_AFTER,ace_name='t2')
        term2=AclCccEntry(ace_name="t5",ace_op=ACL_ENTRY_OPERATION_ADD,adjacency=adj,matches=term1match1,actions=term1Action1)
        tlist2=AclEntry(ccc_entry=term2)
