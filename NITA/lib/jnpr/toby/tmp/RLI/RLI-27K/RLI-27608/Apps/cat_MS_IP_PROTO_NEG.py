...
try:
    ...
    pause() 
    api_request = AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=254, match_op=1, min=255)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=1, match_op=2, min=255)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=0, match_op=2, min=255)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListDelete(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=0, match_op=1, min=254)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=0, match_op=2, min=254)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=0, match_op=1, min=255)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=256, match_op=1, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=256, match_op=2, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=256, match_op=1, min=254)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=256, match_op=2, min=254)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=256, match_op=1, min=255)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=256, match_op=2, min=255)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=1, match_op=2, min=254)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=254, match_op=1, min=254)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindDelete(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=0, match_op=2, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause() 
    api_request = AccessListObjBind(bind_direction=1, bind_family=5, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname), acl=AccessList(ace_list=[AclEntry(mservice_entry=AclMultiServiceEntry(matches=AclEntryMatchMultiService(match_ip_protocols=[AclMatchProtocol(max=0, match_op=1, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMultiServiceAction(actions_nt=AclEntryMultiServiceNonTerminatingAction(action_next_term=1, action_syslog=1, action_sample=1, action_count=AclActionCounter(counter_name="C1"), action_log=1), action_t=AclEntryMultiServiceTerminatingAction(action_accept=1)), ace_op=1))], acl_family=5, acl_flag=0, acl_name="MS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindDelete(api_request, api_timeout)
    print result 
