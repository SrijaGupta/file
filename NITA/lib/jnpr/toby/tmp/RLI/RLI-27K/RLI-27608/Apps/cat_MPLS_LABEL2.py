...
try:
    ...
    pause()
    api_request = AccessListObjBind(bind_direction=1, bind_family=7, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=0, match_op=1, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1))
    print api_request 
    ...
    pause()
    api_request = AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=0, match_op=2, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessListObjBind(bind_direction=1, bind_family=7, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=0, match_op=2, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=1, match_op=1, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessListObjBind(bind_direction=1, bind_family=7, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=1, match_op=1, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=1, match_op=2, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessListObjBind(bind_direction=1, bind_family=7, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=1, match_op=2, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=1048574, match_op=1, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessListObjBind(bind_direction=1, bind_family=7, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=1048574, match_op=1, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=1048574, match_op=2, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1)
    print api_request 
    result = AclService_stub.AccessListAdd(api_request, api_timeout)
    print result 
    ...
    pause()
    api_request = AccessListObjBind(bind_direction=1, bind_family=7, obj_type=1, bind_object=AccessListBindObjPoint(intf=args.iflname + ".0"), acl=AccessList(ace_list=[AclEntry(mpls_entry=AclMplsEntry(matches=AclEntryMatchMpls(match_label2=[AclMatchMplsLabel(max=1048574, match_op=2, min=0)]), ace_name="t1", adjacency=AclAdjacency(type=1), actions=AclEntryMplsAction(actions_nt=AclEntryMplsNonTerminatingAction(action_count=AclActionCounter(counter_name="C1")), action_t=AclEntryMplsTerminatingAction(action_accept=1)), ace_op=1))], acl_family=7, acl_flag=0, acl_name="MPLS1", acl_type=1))
    print api_request 
    result = AclService_stub.AccessListBindAdd(api_request, api_timeout)
    print result 
