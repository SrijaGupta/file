...
class ptx_jflow_verification(jflow_verification):
    """
    ...
    def get_expected_data_template(self):
        ...
        """
        template_dict = {}
        if self.jflow_template_version in ['17.2X75', '19.2'] and \
        ...
        elif self.jflow_template_version in ['17.2X75', '19.2'] and \
        ...
        self.jflow_type == 'INLINE':
            ...
            template_dict['LAST_SWITCHED'] = {
                'Length': '4', 'Type': 'LAST_SWITCHED', 'Element_id': '21'}
            return template_dict
        elif self.jflow_template_version in ['20.2'] and \
        self.cflow_version == '10' and self.template_type == 'ipv4' and \
        self.jflow_type == 'INLINE':
            template_dict['IP_SRC_ADDR'] = {'Length': '4', 'Type': 'IP_SRC_ADDR', 'Element_id': '8'}
            template_dict['IP_DST_ADDR'] = {
            ...
            template_dict['BGP_NEXT_HOP'] = {
                'Length': '4', 'Type': 'BGP_NEXT_HOP', 'Element_id': '18'}
            template_dict['FWD_CLASS'] = {
                'Length': '2', 'Type': 'FWD_CLASS', 'Element_id': '32767'}
            template_dict['PKT_LOSS_PRIORITY'] = {
                'Length': '1', 'Type': 'PKT_LOSS_PRIORITY', 'Element_id': '32766'}
            return template_dict

        elif self.jflow_template_version == '20.2' and \
        self.cflow_version == '10' and self.template_type == 'ipv6' and \
        self.jflow_type == 'INLINE':
            template_dict['IPV6_SRC_ADDR'] = {
                'Length': '16', 'Type': 'IPV6_SRC_ADDR', 'Element_id': '27'}
            ...
            template_dict['PKT_LOSS_PRIORITY'] = {
                'Length': '1', 'Type': 'PKT_LOSS_PRIORITY', 'Element_id': '32766'}
            if float(self.get_junos_version(self.dhandle)) > 19.2:
                template_dict['BGP_IPV6_NEXT_HOP'] = {
                    'Length': '16', 'Type': 'BGP_IPV6_NEXT_HOP', 'Element_id': '63'}
            return template_dict
    ...
    def get_expected_option_template(self):
        ...
        """
        template_dict = {}
        if self.jflow_template_version in ['17.2X75', '19.2', '20.2'] \
        ...
        if self.jflow_template_version in ['17.2X75', '19.2'] \
    ...
    def get_expected_option_template_system_scope(self):
        ...
        elif self.jflow_template_version in ['17.2X75', '19.2'] \
        and self.cflow_version == '9' and self.jflow_type == 'INLINE':
...
[obs_dmn_id_tmp][templ_id][verify_type])
                        ...
                        for selector in comb:
                            ...
                            if count == len(comb):
                                ...
                                'BGPNextHop' not in do_not_verify:
                                    ...
                                    self.jflow_template_version in ['17.2X75', '19.2', '20.2']:
        ...
        if cflow_version == "10":
            ...
            for cflow in cflow_list:
                ...
                if "Template (V10 [IPFIX])" in template_type and frame_number == 1:
                    ...
                    if first_flow_sequence == True and current_flow_seq == 0:
                        print("First frame flow sequence value received as 0")
    ...
    def get_ptx_template_ids(self, **kwarg):
        ...
        if identifier == "Option Refresh Packets":
            identifier = "Template Refresh Pkts"
        else:
            identifier = "Template Refresh Secs"

        output_list = re.findall(
            r'Template Number .*?Number of Collectors  : \d+',
    ...
    def create_instance(self):
        """ method to create instance of
            of class "ptx_jflow_verification"
        """
        self.objj = ptx_jflow_verification()
        #s1.init( **kwargs)
        return self.objj
