...
#rom jnpr.toby.utils.xml_tool import xml_tool
#from jnpr.toby.services import utils
...
class MissingMandatoryArgument(ValueError):
    ...
    def __init__(self, err_msg):
        ...
        super(MissingMandatoryArgument, self).__init__("Missing mandatory argument, {}".format(err_msg))

class usf_rutils(object):
    ...
    def set_resource(self, resource=None, controller=None):
        ...
        self.dh = t.get_handle(resource=resource, controller=controller)
